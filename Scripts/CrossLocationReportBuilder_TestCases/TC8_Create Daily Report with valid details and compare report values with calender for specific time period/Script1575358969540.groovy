...
WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CreatedReports/Verify Date Picker is displayed as defined Data Grain - Copy'), 
    [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('ReportBuilder_Pages/Restaurant_Intranet_Dashboard_Page/Fetch variable values from created report and do comapre with calendar values'), 
    [('SetUpListToGetData') : valuesFromCalendarDashboard, ('DayWiseDates') : NoOfDaysFromReports, ('NoOfAddedColumns') : TotalNoOfColumnsAdded //TotalNoOfColumnsAdded
    ], FailureHandling.CONTINUE_ON_FAILURE)
