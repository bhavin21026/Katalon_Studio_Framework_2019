...
WebUI.verifyElementVisible(findTestObject('ReportSetupScreen/Edit Columns/input_ToRange'))

WebUI.verifyElementVisible(findTestObject('ReportSetupScreen/Edit Columns/label_OutsideValue'))

WebUI.verifyElementVisible(findTestObject('ReportSetupScreen/Edit Columns/label_WithinValue'))
