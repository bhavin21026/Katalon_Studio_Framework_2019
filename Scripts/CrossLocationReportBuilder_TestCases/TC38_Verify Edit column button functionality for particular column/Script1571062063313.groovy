...
WebUI.verifyElementClickable(findTestObject('ReportSetupScreen/Create Columns/btn_Edit'))

WebUI.verifyElementPresent(findTestObject('ReportSetupScreen/Create Columns/btn_Edit'), 0)
