...
if (DataGrain.equalsIgnoreCase('Daily') && PresentBy.equalsIgnoreCase('Day')) {
    ...
    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/Average Ticket - Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/Labor Cost-Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/Gross Sales -Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/Labor Hours -Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/COGS - Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Daily Data Grain/Prime Cost - Daily Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)
    ...
    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/Average Ticket - Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/Labor Cost-Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/Gross Sales -Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/Labor Hours -Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/COGS - Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Weekly Data Grain/Prime Cost - Weekly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)
    ...
    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/Average Ticket - Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/Labor Cost-Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/Gross Sales -Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/Labor Hours -Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/COGS - Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)

    WebUI.callTestCase(findTestCase('ReportBuilder_Pages/CrossLocationReportBuilderSetup_Page/Column Selection By Data Grain/Monthly Data Grain/Prime Cost - Monthly Data Grain'), 
        [:], FailureHandling.CONTINUE_ON_FAILURE)
