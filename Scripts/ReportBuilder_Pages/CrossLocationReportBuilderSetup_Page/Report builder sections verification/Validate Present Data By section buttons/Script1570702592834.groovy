...
WebUI.verifyElementPresent(findTestObject('ReportSetupScreen/Present Data By/button_Day'), 0)

WebUI.verifyElementVisible(findTestObject('ReportSetupScreen/Present Data By/button_Day'))

String strPresentDataByClass = WebUI.getAttribute(findTestObject('ReportSetupScreen/Present Data By/button_Day'), 'class')

String strPresentDataByButtonName = WebUI.getText(findTestObject('ReportSetupScreen/Present Data By/button_Day'))
