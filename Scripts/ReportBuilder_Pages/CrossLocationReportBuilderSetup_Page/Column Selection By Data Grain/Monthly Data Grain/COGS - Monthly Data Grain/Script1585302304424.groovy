...
WebUI.verifyElementClickable(findTestObject('ReportSetupScreen/DataGroupValues/COGS/tpl_COGS'))

WebUI.click(findTestObject('ReportSetupScreen/DataGroupValues/COGS/tpl_COGS'))
