...
not_run: WebUI.waitForElementClickable(findTestObject('Page_Restaurant Intranet/link_ProfileIcon'), GlobalVariable.ExplicitWait)

not_run: WebUI.verifyElementVisible(findTestObject('Page_Restaurant Intranet/link_ProfileIcon'))
