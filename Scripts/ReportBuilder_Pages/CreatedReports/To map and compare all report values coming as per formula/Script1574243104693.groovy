...
double GrossalesDollor = CreatedReportValues.get('Gross Sales $')

double GrossalesLYDollor = CreatedReportValues.get('Gross Sales LY $')

double GrossalesvsLYDollor = CreatedReportValues.get('Gross Sales vs LY $')

double GrossalesvsLYPercent = CreatedReportValues.get('Gross Sales vs LY %')

//Grab LaborHours Values
double TotalHours = CreatedReportValues.get('Total hours')

double OTHours = CreatedReportValues.get('OT hours')

double TotalHoursLY = CreatedReportValues.get('Total hours LY')

double OTHoursLY = CreatedReportValues.get('OT hours LY')

double TotalHoursvsLY = CreatedReportValues.get('Total hours vs LY')

double OTHoursvsLY = CreatedReportValues.get('OT hours vs LY')
...
if ((PresentBy.equalsIgnoreCase('Week') || PresentBy.equalsIgnoreCase('Month')) || PresentBy.equalsIgnoreCase('EntireRange')) {
    SalesBudgetedDollor = CustomKeywords.'reportbuildercustom.NetSales_Formulas.calculate_NetSalesBudget_Dollor'(dblSalesBudget, 
        NetSalesLY)
...
double GrossalesvsLYDollorCalculated = CustomKeywords.'reportbuildercustom.GrossSales_Formulas.calculate_GrossSalesvsLYDollor'(
    GrossalesDollor, GrossalesLYDollor)

double GrossalesvsLYPercentCalculated = CustomKeywords.'reportbuildercustom.GrossSales_Formulas.calculate_GrossSalesvsLYPercent'(
    GrossalesDollor, GrossalesLYDollor)

//Calculation of LaborHours Formula
double TotalHoursvsLYCalculated = CustomKeywords.'reportbuildercustom.LaborHours_Formulas.calculate_TotalHoursvsLY'(TotalHours, 
    TotalHoursLY)

double OTHoursvsLYCalculated = CustomKeywords.'reportbuildercustom.LaborHours_Formulas.calculate_OTHoursvsLY'(OTHours, OTHoursLY)
...
//GuestCount Compare
CustomKeywords.'compareColumnsValues.GuestCountValuesCompare.toVerifyGuestVsLYCountColumnsValues'(GrossalesvsLYDollor, 
    GrossalesvsLYDollorCalculated, Store)
...
CustomKeywords.'compareColumnsValues.GrossSalesValuesCompare.toVerifyGrossSalesvsLYDollorReportColumnsValues'(GrossalesvsLYDollor, GrossalesvsLYDollorCalculated, Store)
CustomKeywords.'compareColumnsValues.GrossSalesValuesCompare.toVerifyGrossSalesvsLYPercentReportColumnsValues'(GrossalesvsLYPercent, GrossalesvsLYPercentCalculated, Store)



//Labor HoursCompare

CustomKeywords.'compareColumnsValues.LaborHoursValuesCompare.toVerifyTotalhoursvsLYReportColumnsValues'(TotalHoursvsLY, TotalHoursvsLYCalculated, Store)
CustomKeywords.'compareColumnsValues.LaborHoursValuesCompare.toVerifyOThoursvsLYReportColumnsValues'(OTHoursvsLY, OTHoursvsLYCalculated, Store)
...
if ((PresentBy.equalsIgnoreCase('Week') || PresentBy.equalsIgnoreCase('Month')) || PresentBy.equalsIgnoreCase('EntireRange')) {
    ...
    CustomKeywords.'compareColumnsValues.LaborCostValuesCompare.toVerifyLaborCostBudgetDollarsactualsalesColumnsValues'(
        LaborCostBudget_ActualSales, LaborCostBudgetDollarActualsales, Store)

    CustomKeywords.'compareColumnsValues.LaborCostValuesCompare.toVerifyLaborCostBudgetDollarsBudgetedsalesColumnsValues'(
        LaborCostBudget_BudgetSales, LaborCostBudgetDollarBudgetsales, Store)
