...
if (presentBy.equalsIgnoreCase('Day') ||(DataGrain.equalsIgnoreCase('Daily') && presentBy.equalsIgnoreCase('EntireRange'))) {
...
} else if (presentBy.equalsIgnoreCase('Week') ||(DataGrain.equalsIgnoreCase('Weekly') && presentBy.equalsIgnoreCase('EntireRange'))) {
...
} else if (presentBy.equalsIgnoreCase('Month')||(DataGrain.equalsIgnoreCase('Monthly') && presentBy.equalsIgnoreCase('EntireRange'))) {
