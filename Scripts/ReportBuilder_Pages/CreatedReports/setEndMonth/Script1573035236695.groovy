...
//println MonthValue
String enteredYear = GlobalVariable.EndMonthYear
...
while (!(WebUI.getText(findTestObject('Object Repository/Created Reports Objects/dtp_EndMonthValue')).equalsIgnoreCase(startYear))) {
    WebUI.click(findTestObject('ReportBuilderUI/cld2_backbtn'))
}
