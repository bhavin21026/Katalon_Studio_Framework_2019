...
public class WriteExcelLossPreventionFormula
{
	String filePath
	String fileName
	...
	@Keyword
	public void writeExcelDailyFormulaCheck(String[] dataToWrite) throws IOException
	{
		...
		if(PresentBy.equalsIgnoreCase("Day"))
		{
			...
			fileName=GlobalVariable.FileName_DailyFormula
		}
		else if(PresentBy.equalsIgnoreCase("Week"))
		{

			filePath=GlobalVariable.Path_CompareWithCalendar
			fileName=GlobalVariable.FileName_WeeklyFormula
		}
		else if(PresentBy.equalsIgnoreCase("Month"))
		{
			filePath=GlobalVariable.Path_CompareWithCalendar
			fileName=GlobalVariable.FileName_Monthlyormula
		}
		else if(PresentBy.equalsIgnoreCase("EntireRange"))
		{
			filePath=GlobalVariable.Path_CompareWithCalendar
			fileName=GlobalVariable.FileName_EntireRange
		}

		//Create an object of File class to open xlsx file

		File file =  new File(filePath+'\\LossPrevention'+fileName);
	...
	@Keyword
	public void writeExcelPassFormulaCheck(String[] dataToWrite) throws IOException
	{
	...
	@Keyword
	public void writeExcelAllStorePass(String[] dataToWrite) throws IOException
	{
	...
	@Keyword
	public void writeExcelAllStoreFail(String[] dataToWrite) throws IOException
	{
	...
	@Keyword
	public void writeRawValues(String[] dataToWrite) throws IOException
	{
