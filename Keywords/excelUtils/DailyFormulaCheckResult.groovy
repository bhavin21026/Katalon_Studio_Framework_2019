...
public class DailyFormula extends ExcelsCustom {
	...
	@Keyword
	def dailyFormulaCheck() throws FileNotFoundException, IOException {

		if(PresentBy.equalsIgnoreCase("Day")) {
			Workbook wb = new XSSFWorkbook();

			OutputStream fileOut = new FileOutputStream(GlobalVariable.Path_CompareWithCalendar+'\\'+GlobalVariable.FileName_DailyFormula)
			...
			OutputStream fileOut = new FileOutputStream(GlobalVariable.Path_CompareWithCalendar+'\\'+GlobalVariable.FileName_WeeklyFormula)
			...
			OutputStream fileOut = new FileOutputStream(GlobalVariable.Path_CompareWithCalendar+'\\'+GlobalVariable.FileName_Monthlyormula)
			...
			OutputStream fileOut = new FileOutputStream(GlobalVariable.Path_CompareWithCalendar+'\\'+GlobalVariable.FileName_EntireRange)
