...
public class LaborHours_Formulas {

	@Keyword
	def double calculate_TotalHoursvsLY(double TotalHoursTY, double TotalHoursLY) {

		double dblTotalHoursLYLY=TotalHoursTY-TotalHoursLY
		double TotalHoursvsLYValue= Math.round(dblTotalHoursLYLY * 100) / 100
		return TotalHoursvsLYValue
	}

	@Keyword
	def double calculate_OTHoursvsLY(double OTHoursTY, double OTHoursLY) {

		double dblOTHoursLYLY=OTHoursTY-OTHoursLY
		double OTHoursvsLYValue= Math.round(dblOTHoursLYLY * 100) / 100
		return OTHoursvsLYValue
	}
}
